...
public class UUIDGenerator {
    ...
    /**
     * UUID 生成器
     * @param workerId 机器ID worker Id can't be greater than 31 or less than 0
     * @param datacenterId 数据中心ID或机房ID datacenter Id can't be greater than 31 or less than 0
     */
    ...
    public synchronized long nextUUID() {
         ...
         * 则sequence加一(0-4095循环); 对新的timestamp，sequence从0开始
         */
